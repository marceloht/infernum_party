...
function renderStats(){
  document.getElementById("stat-drops").textContent = DROPS.length;
  document.getElementById("stat-sold").textContent = DROPS.filter(d => (d.status||"").includes("Vendido")).length;
  ...
  document.getElementById("cnt-drops").textContent = DROPS.length;
  document.getElementById("cnt-chars").textContent = CHARACTERS.length;
  document.getElementById("cnt-parties").textContent = PARTIES.length;
  document.getElementById("cnt-ref").textContent = ITEM_REFERENCE.length;
}
